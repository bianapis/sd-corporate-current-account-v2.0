...
@BianRestController
public class CorporateCurrentAccountApiController {

	@Autowired
	CorporateCurrentAccountApiService service;
	
	@Fulfill.Activate
	public BianResponse<SDCorporateCurrentAccountActivateOutputModel> activate(@RequestBody BianRequest<SDCorporateCurrentAccountActivateInputModel> bianRequest) {
		return BianResponse.forSuccess(service.activate(bianRequest.getData()));
	}
	
	@Fulfill.Configure
	public BianResponse<SDCorporateCurrentAccountConfigureOutputModel> configure(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDCorporateCurrentAccountConfigureInputModel> bianRequest) {
		return BianResponse.forSuccess(service.configure(sdReferenceId, bianRequest.getData()));
	}
	
	@Fulfill.Control
	public BianResponse<CRCorporateCurrentAccountFulfillmentArrangementControlOutputModel> control(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRCorporateCurrentAccountFulfillmentArrangementControlInputModel> bianRequest) {
	...
	@Fulfill.Feedback
	public BianResponse<SDCorporateCurrentAccountFeedbackOutputModel> feedback(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDCorporateCurrentAccountFeedbackInputModel> bianRequest) {
		return BianResponse.forSuccess(service.feedback(sdReferenceId, bianRequest.getData()));
	}
	
	@Fulfill.Initiate
	public BianResponse<CRCorporateCurrentAccountFulfillmentArrangementInitiateOutputModel> initiate(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<CRCorporateCurrentAccountFulfillmentArrangementInitiateInputModel> bianRequest) {
	...
	@Fulfill.Retrieve
	public BianResponse<CRCorporateCurrentAccountFulfillmentArrangementRetrieveOutputModel> retrieve(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId) {
	...
	@Fulfill.RetrieveSD
	public BianResponse<SDCorporateCurrentAccountRetrieveOutputModel> retrieveSD(@PathVariable("sd-reference-id") String sdReferenceId) {
		return BianResponse.forSuccess(service.retrieveSD(sdReferenceId));
	}
	
	@Fulfill.Update
	public BianResponse<CRCorporateCurrentAccountFulfillmentArrangementUpdateOutputModel> update(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRCorporateCurrentAccountFulfillmentArrangementUpdateInputModel> bianRequest) {
